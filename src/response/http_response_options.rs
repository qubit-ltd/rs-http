...
pub(crate) struct HttpResponseOptions {
    ...
    /// Maximum raw bytes retained for structured status errors.
    ...
    /// Completion requirement for JSON SSE streams.
...
impl Default for HttpResponseOptions {
    fn default() -> Self {
        Self {
            ...
            error_response_body_limit: crate::constants::DEFAULT_ERROR_RESPONSE_BODY_LIMIT_BYTES,
...
impl HttpResponseOptions {
    ...
    pub(crate) fn from_client_options(options: &HttpClientOptions, log_redactor: Redactor) -> Self {
        Self {
            ...
            error_response_body_limit: options.error_response_body_limit.max(1),
            ...
            sse_completion_policy: options.sse_completion_policy,
            log_redactor,
        }
    }
}
